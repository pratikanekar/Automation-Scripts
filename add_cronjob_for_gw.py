...
result_df = pd.DataFrame(columns=['IP Address', 'Cronjob Added'])
...
try:
    for hostname in hostlist:
        ...
        with Connection(
            ...
            result_df = pd.concat([result_df, pd.DataFrame({'IP Address': [hostname], 'Cronjob Added': [True]})], ignore_index=True)
